...
{
	unichar theChar = [QSKeyCodeTranslator unicharForKeyCode:aKeyCode];

	switch( theChar ) {
		case kHomeCharCode:
			theChar = NSHomeFunctionKey;
			break;
		case kEndCharCode:
			theChar = NSEndFunctionKey;
			break;
		case kHelpCharCode:
			theChar = NSHelpFunctionKey;
			break;
		case kPageUpCharCode:
			theChar = NSPageUpFunctionKey;
			break;
		case kPageDownCharCode:
			theChar = NSPageDownFunctionKey;
			break;
		case kFunctionKeyCharCode:
			theChar = unicodeForFunctionKey(aKeyCode);
			break;
		case kClearCharCode:
		...
		case kDeleteCharCode:
			theChar = NSDeleteCharFunctionKey;
			break;
	}
	return theChar;
}
