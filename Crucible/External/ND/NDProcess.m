...
{
	OSType			theOSType[2] = {0, 0};
	UInt32			theSignature[2] = {0, 0};
	...
	{
		theOSType[0] = [self type];
		theSignature[0] = [self signature];

		theOSTypeString = (theOSType[0]) ? [NSString stringWithCString:(char*)theOSType encoding:NSASCIIStringEncoding] : @"NULL";
		theSignatureString = (theSignature[0]) ? [NSString stringWithCString:(char*)theSignature encoding:NSASCIIStringEncoding] : @"NULL";
