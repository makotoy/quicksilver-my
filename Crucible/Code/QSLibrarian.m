...
- (float) estimatedTimeForSearchInSet:(id)set {
	...
	// if (VERBOSE) QSLog(@"Estimte: %fms avg: %dµs", estimate*1000, (int)(searchSpeed*1000000));
...
- (NSMutableArray *)scoredArrayForString:(NSString *)searchString inSet:(NSArray *)set mnemonicsOnly:(BOOL)mnemonicsOnly {
	...
	//   if (VERBOSE) QSLog(@"Ranking: %fms avg: %dµs", -([date timeIntervalSinceNow] *1000), (int) (speed*1000000)); date = [NSDate date];
